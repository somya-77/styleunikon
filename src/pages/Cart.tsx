            ...
            <AnimatePresence>
              {items.map((item) => (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: 20 }}
                  className="border-2 border-foreground grid grid-cols-[100px_1fr] sm:grid-cols-[120px_1fr] gap-4"
                >
                  ...
                  <div className="p-4 flex flex-col justify-between">
                    ...
                    <div className="flex items-center justify-between mt-3">
                      ...
                      <div className="flex items-center gap-4">
                        <span className="font-heading text-sm font-bold">{formatPrice(item.price * item.quantity)}</span>
                        <button
